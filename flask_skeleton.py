...
​
    ...
    results = session.query(Encounter.State, Encounter.Age, Encounter.Gender, Encounter.Race, Encounter.Year, Encounter.Mental_Illness).all()
    session.close()
​
    # Convert list of tuples into normal list
    all_encounters = []
    for state, age, gender, race, year, illness in results:
        encounter_dict={}
